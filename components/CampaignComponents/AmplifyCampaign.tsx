    ...
    return (
        <View style={styles.mainContent}>
            ...
            <View style={styles.header}>
                <Text style={styles.headerTitle}>Amplify Campaigns</Text>
            </View>
            ...
            <View style={styles.emptyContainer}>
                <View style={styles.illustrationCard}>
                    <View style={styles.innerGraphic}>
                        <Ionicons name="phone-portrait" size={100} color={theme.tint} style={{opacity: 0.1}} />
                        <Ionicons name="stats-chart" size={140} color={theme.tint} style={styles.floatingIcon} />
                    </View>
                </View>
                <Text style={styles.emptyTitle}>Coming Soon</Text>
                <Text style={styles.emptySubtitle}>Amplify campaigns are under construction.</Text>
            </View>
        </View>
    );
}
